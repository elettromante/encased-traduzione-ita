...
## Note Tecniche
* **Risoluzione Schermo Nero:** In caso di errori al caricamento, si consiglia di utilizzare come base il file `Es.locale` (Spagnolo) o `Fr.locale` (Francese), applicare la patch italiana con il comando `--update` e rinominare il file finale in modo coerente con la lingua selezionata nel menu.
